...
#[test]
#[ignore]
fn test_clocks_add_minutes() {
    let clock = Clock::new(10, 0) + Clock::new(0, 3);
    assert_eq!(clock.to_string(), "10:03");
}

#[test]
#[ignore]
fn test_clocks_add_no_minutes() {
    let clock = Clock::new(6, 41) + Clock::new(0, 0);
    assert_eq!(clock.to_string(), "06:41");
}

#[test]
#[ignore]
fn test_clocks_add_to_next_hour() {
    let clock = Clock::new(0, 45) + Clock::new(0, 40);
    assert_eq!(clock.to_string(), "01:25");
}

#[test]
#[ignore]
fn test_clocks_add_more_than_one_hour() {
    let clock = Clock::new(10, 0) + Clock::new(1, 1);
    assert_eq!(clock.to_string(), "11:01");
}

#[test]
#[ignore]
fn test_clocks_add_more_than_two_hours_with_carry() {
    let clock = Clock::new(0, 45) + Clock::new(2, 40);
    assert_eq!(clock.to_string(), "03:25");
}

#[test]
#[ignore]
fn test_clocks_add_across_midnight() {
    let clock = Clock::new(23, 59) + Clock::new(0, 2);
    assert_eq!(clock.to_string(), "00:01");
}

#[test]
#[ignore]
fn test_clocks_add_more_than_one_day() {
    let clock = Clock::new(5, 32) + Clock::new(25, 0);
    assert_eq!(clock.to_string(), "06:32");
}

#[test]
#[ignore]
fn test_clocks_add_more_than_two_days() {
    let clock = Clock::new(1, 1) + Clock::new(58, 20);
    assert_eq!(clock.to_string(), "11:21");
}

#[test]
#[ignore]
fn test_clocks_sub_minutes() {
    let clock = Clock::new(10, 3) - Clock::new(0, 3);
    assert_eq!(clock.to_string(), "10:00");
}

#[test]
#[ignore]
fn test_clocks_sub_to_previous_hour() {
    let clock = Clock::new(10, 3) - Clock::new(0, 30);
    assert_eq!(clock.to_string(), "09:33");
}

#[test]
#[ignore]
fn test_clocks_sub_more_than_an_hour() {
    let clock = Clock::new(10, 3) - Clock::new(1, 10);
    assert_eq!(clock.to_string(), "08:53");
}

#[test]
#[ignore]
fn test_clocks_sub_across_midnight() {
    let clock = Clock::new(0, 3) - Clock::new(0, 4);
    assert_eq!(clock.to_string(), "23:59");
}

#[test]
#[ignore]
fn test_clocks_sub_more_than_two_hours() {
    let clock = Clock::new(0, 0) - Clock::new(2, 40);
    assert_eq!(clock.to_string(), "21:20");
}

#[test]
#[ignore]
fn test_clocks_sub_more_than_two_hours_with_borrow() {
    let clock = Clock::new(6, 15) - Clock::new(2, 40);
    assert_eq!(clock.to_string(), "03:35");
}

#[test]
#[ignore]
fn test_clocks_sub_more_than_one_day() {
    let clock = Clock::new(5, 32) - Clock::new(25, 0);
    assert_eq!(clock.to_string(), "04:32");
}
...
#[test]
#[ignore]
fn test_clocks_sub_more_than_two_days() {
    let clock = Clock::new(2, 20) - Clock::new(50, 0);
    assert_eq!(clock.to_string(), "00:20");
}

#[test]
#[ignore]
fn test_clock_and_i32_add_minutes() {
...
#[test]
#[ignore]
fn test_clock_and_i32_add_no_minutes() {
...
#[test]
#[ignore]
fn test_clock_and_i32_add_to_next_hour() {
...
#[test]
#[ignore]
fn test_clock_and_i32_add_more_than_one_hour() {
...
#[test]
#[ignore]
fn test_clock_and_i32_add_more_than_two_hours_with_carry() {
...
#[test]
#[ignore]
fn test_clock_and_i32_add_across_midnight() {
...
#[test]
#[ignore]
fn test_clock_and_i32_add_more_than_one_day() {
...
#[test]
#[ignore]
fn test_clock_and_i32_add_more_than_two_days() {
...
#[test]
#[ignore]
fn test_clock_and_i32_sub_minutes() {
...
#[test]
#[ignore]
fn test_clock_and_i32_sub_to_previous_hour() {
...
#[test]
#[ignore]
fn test_clock_and_i32_sub_more_than_an_hour() {
...
#[test]
#[ignore]
fn test_clock_and_i32_sub_across_midnight() {
...
#[test]
#[ignore]
fn test_clock_and_i32_sub_more_than_two_hours() {
...
#[test]
#[ignore]
fn test_clock_and_i32_sub_more_than_two_hours_with_borrow() {
...
#[test]
#[ignore]
fn test_clock_and_i32_sub_more_than_one_day() {
    let clock = Clock::new(5, 32) - 1500;
    assert_eq!(clock.to_string(), "04:32");
}
...
#[test]
#[ignore]
fn test_clock_and_i32_sub_more_than_two_days() {
